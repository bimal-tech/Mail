...
function compose_email(event, recipients = '', subject = '', body = '') {
    ...
    document.querySelector('#compose').style.borderBottom = '3px solid #0000ff ';
        document.querySelector('#compose').style.color = '#0000ff ';
...
function load_mailbox(mailbox) {
    ...
    if (mailbox === "inbox") {
        ...
        document.querySelector('#compose').style.borderBottom = '3px solid lightgrey';
        document.querySelector('#compose').style.color = '#5f6368';
